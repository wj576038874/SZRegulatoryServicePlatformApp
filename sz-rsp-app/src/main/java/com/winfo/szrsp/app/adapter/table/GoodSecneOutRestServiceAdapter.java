...
public class GoodSecneOutRestServiceAdapter extends CommonAdapter<OrdinaryGoodsKaiXiangData> {
    /**
     * 构造方法
     *
    ...
    public GoodSecneOutRestServiceAdapter(Context context, List<OrdinaryGoodsKaiXiangData> datas, int resource) {
    ...
    public void convert(ViewHolder holder, int position) {
        ...
        final OrdinaryGoodsKaiXiangData data = datas.get(position);
        ...
        //文件名称
        String name = "普通货物集装箱开箱检查记录表"+"_"+data.getInspectNo()+".pdf";
        ...
        final DownInfo apkApi=new DownInfo(ServerReqAddress.BASE_ADDRESS+"sz/ctGoodSecneOutRestService/outPutPDF?projectSu=SZMSA&accessToken="+access_token+"&requestSource=&parameterJson=" +params);
