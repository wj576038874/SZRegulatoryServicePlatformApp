...
public class CompleteFragment extends Fragment implements ITaskListActivity {
...
//        page=1;
//        this.list.clear();
//        presenter.getTaskListData("1","20","8",false);
//    }
    ...
    private void initData() {
        ...
        presenter.getTaskListData(""+page,"20","8",true);
    }
    ...
    private void initEvent() {
        ...
        mRefreshLayout.setOnLoadmoreListener(new OnLoadmoreListener() {
            ...
            public void onLoadmore(RefreshLayout refreshlayout) {
                ...
                presenter.getTaskListData(""+page,"20","8",false);
