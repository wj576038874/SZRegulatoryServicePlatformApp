...
import com.winfo.szrsp.app.widget.wheelview.adapters.ArrayWheelAdapter;
import com.winfo.szrsp.app.widget.wheelview.lib.WheelView;
        ...
        wheelListener_option1 = new OnItemSelectedListener() {
			...
			public void onItemSelected(int index) {
				...
				if (mOptions2Items != null) {
					...
					wv_option2.setAdapter(new ArrayWheelAdapter<T>(mOptions2Items.get(index)));
