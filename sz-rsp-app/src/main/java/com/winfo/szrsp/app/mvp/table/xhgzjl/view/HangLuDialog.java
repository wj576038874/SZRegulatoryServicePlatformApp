...
public class HangLuDialog implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public HangLuDialog(Context context) {
...
//        // 窗体距离屏幕最右边或者最左边10dp所对应的像素（把10dp转换成px）
        ...
        chuliView = LayoutInflater.from(context).inflate(R.layout.dialog_xhgzjl_hanglu, null);
        dialog.show();
            ...
            case R.id.but_save:
                if (!ckItem1.isChecked() && !ckItem2.isChecked() && !ckItem3.isChecked() && !ckItem4.isChecked() && !ckItem5.isChecked() && !ckItem6.isChecked()
                    ...
                    if (ckItem1.isChecked()) {
                        ...
                        if ("".equals(otherText)) {
                            ToastUtils.showToast(mContext, "请填写检查项目!");
                            return;
                        } else {
                            str = otherText;
                        }
    ...
    public void show(String str) {
        if ("大亚湾核电站码头进港航道".equals(str)) {
            ...
            ckItem11.setChecked(false);
            ckItem12.setChecked(false);
        } else if ("蛇口航道10-12号浮".equals(str)) {
            ckItem1.setChecked(false);
            ckItem2.setChecked(false);
            ckItem3.setChecked(false);
            ckItem4.setChecked(false);
            ...
            ckItem11.setChecked(false);
            ckItem12.setChecked(false);
        } else if ("妈湾航道（北航道）北段".equals(str)) {
            ckItem1.setChecked(false);
            ckItem2.setChecked(false);
            ckItem3.setChecked(false);
            ckItem4.setChecked(false);
            ...
            ckItem11.setChecked(false);
            ckItem12.setChecked(false);
        } else if ("妈湾航道（北航道）南段".equals(str)) {
            ckItem1.setChecked(false);
            ckItem2.setChecked(false);
            ckItem3.setChecked(false);
            ckItem4.setChecked(false);
