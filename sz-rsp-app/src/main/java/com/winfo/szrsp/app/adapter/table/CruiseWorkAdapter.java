...
public class CruiseWorkAdapter extends CommonAdapter<DetailCruiseWorkData> {
    ...
    public CruiseWorkAdapter(Context context, List<DetailCruiseWorkData> datas, int resource) {
    ...
    public void convert(ViewHolder holder, int position) {
        ...
        final DetailCruiseWorkData data = datas.get(position);
        tv_boat_name.setText(data.getShipName());
        tv_ferry_name.setText(data.getAnchorageArea());
        tv_sj.setText(data.getCreateTime());
        //开始判断本地是否已经下载文档了
        //文件夹名称
        String path = SDCardUtils.getRootDirectory() + "/DownloadSZMSA_Doc/";
        //文件名称
        String name = "巡航工作记录表" + "_" + data.getInspectNo() + ".pdf";
        ...
        final DownInfo apkApi = new DownInfo(ServerReqAddress.BASE_ADDRESS + "sz/ctCruisingRecoreRestService/outPutPDF?projectSu=SZMSA&accessToken=" + access_token + "&requestSource=&parameterJson=" + params);
