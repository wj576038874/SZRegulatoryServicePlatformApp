...
public class TaskRejectDialog {
    ...
    public TaskRejectDialog(Context context) {
        ...
        rejectView = LayoutInflater.from(mContext).inflate(R.layout.pop_reject_reason, null);
        dialogReject.show();
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (pop_reject_reason_edt.getText().toString().length() < 1) {
                    ToastUtils.showToast(mContext, "请填写退回描述");
                } else {
