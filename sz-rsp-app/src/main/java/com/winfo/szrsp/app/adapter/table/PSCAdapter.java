...
public class PSCAdapter extends CommonAdapter<CtPscFrom> {
    ...
    public PSCAdapter(Context context, List<CtPscFrom> datas, int resource) {
    ...
    public void convert(ViewHolder holder, int position) {
        ...
        final CtPscFrom data = datas.get(position);
        tv_boat_name.setText(data.getShipNameEn());
        tv_ferry_name.setText(data.getBerthCode());
        tv_sj.setText(data.getInspectDate());
        //开始判断本地是否已经下载文档了
        //文件夹名称
        String path = SDCardUtils.getRootDirectory()+ "/DownloadSZMSA_Doc//";
        //文件名称
        String name =  "PSCForm"+"_"+data.getInspectNo()+".pdf";
       ...
       final DownInfo apkApi=new DownInfo(ServerReqAddress.BASE_ADDRESS+"sz/ctPscFromRestService/outPutPDF?projectSu=SZMSA&accessToken="+access_token+"&requestSource=&parameterJson=" +params);
        //文件存储位置
