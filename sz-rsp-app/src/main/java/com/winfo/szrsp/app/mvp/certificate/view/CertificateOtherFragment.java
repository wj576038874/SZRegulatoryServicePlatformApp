...
public class CertificateOtherFragment extends Fragment implements ICertificateActvity,View.OnClickListener{
    ...
    private void initEvent() {
        ...
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                presenter.loadCertificateData(ais.getID(),"other",false);
            }
        });
    }
    ...
    private void initData() {
        ...
        presenter.loadCertificateData(ais.getID(),"other",true);
    ...
    public void OnSucess(CertificateInfo certificateInfo) {
        ...
        if(certificateInfo.getOther()!=null&&certificateInfo.getOther().size()>0){
            noticeCerMain.noticeCerMain("other",false);
            mRefreshLayout.setVisibility(View.VISIBLE);
            faile_view.setVisibility(View.GONE);

            adapter = new CertificateAdapter(getActivity(), certificateInfo.getOther(), R.layout.certificate_item);
            gridView.setAdapter(adapter);
        }else {
            noticeCerMain.noticeCerMain("other",true);
