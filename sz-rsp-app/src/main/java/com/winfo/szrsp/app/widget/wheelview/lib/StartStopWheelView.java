 ...
 * 3d滚轮控件
 */
public class StartStopWheelView extends View {
    ...
    public StartStopWheelView(Context context) {
        this(context, null);
    }

    public StartStopWheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initLoopView(Context context) {
        ...
        handler = new StartStopMessageHandler(this);
        gestureDetector = new GestureDetector(context, new StartStopLoopViewGestureListener(this));
...
//        paintCenterText.setTypeface(Typeface.MONOSPACE);
    ...
    void smoothScroll(ACTION action) {
        ...
        mFuture = mExecutor.scheduleWithFixedDelay(new StartStopSmoothScrollTimerTask(this, mOffset), 0, 10, TimeUnit.MILLISECONDS);
    }

    protected final void scrollBy(float velocityY) {
        cancelFuture();

        mFuture = mExecutor.scheduleWithFixedDelay(new StartStopInertiaTimerTask(this, velocityY), 0, VELOCITYFLING, TimeUnit.MILLISECONDS);
    }
    ...
    protected final void onItemSelected() {
        if (onItemSelectedListener != null) {
            postDelayed(new StartStopOnItemSelectedRunnable(this), 200L);
        }
    }
