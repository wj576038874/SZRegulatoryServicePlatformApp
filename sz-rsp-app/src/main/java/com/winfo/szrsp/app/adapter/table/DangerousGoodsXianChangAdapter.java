...
public class DangerousGoodsXianChangAdapter extends CommonAdapter<DetailDangerousGoodsXianChangData> {
     ...
     */
    public DangerousGoodsXianChangAdapter(Context context, List<DetailDangerousGoodsXianChangData> datas, int resource) {
    ...
    public void convert(ViewHolder holder, int position) {
        ...
        final DetailDangerousGoodsXianChangData data = datas.get(position);
        tv_boat_name.setText(data.getShipNameCn());
        tv_ferry_name.setText(data.getShipNameEn());
        ...
        //文件名称
        String name = "集装箱危险货物现场检查记录表" + "_" + data.getInspectNo() + ".pdf";
        ...
        final DownInfo apkApi = new DownInfo(ServerReqAddress.BASE_ADDRESS + "sz/ctDangerPolluteSceneRestService/outPutPDF?projectSu=SZMSA&accessToken=" + finalAccess_token + "&requestSource=&parameterJson=" + params);
        //文件存储位置
