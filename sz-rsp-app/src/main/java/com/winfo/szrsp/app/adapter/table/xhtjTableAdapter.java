 ...
 * @Package: com.winfo.szrsp.app.adapter.table
 * @Filename: xhtjTableAdapter
 * @Author: lsj
 * @Date: 2018/1/24  11:26
 * @Description:
 * @Version:
 */
public class xhtjTableAdapter extends CommonAdapter<CtCruiseStatistics> {
    /**
     * 构造方法
     *
    ...
    public xhtjTableAdapter(Context context, List<CtCruiseStatistics> datas, int resource) {
    ...
    public void convert(ViewHolder holder, int position) {
        ...
        CtCruiseStatistics data = datas.get(position);
        tv_boat_name.setText(data.getShipName());
        tv_ferry_name.setText("");
        tv_sj.setText(data.getCruiseTime());
        ...
        //文件名称
        String name = data.getShipName()+"_"+data.getInspectNo()+".pdf";
        ...
        final DownInfo apkApi = new DownInfo(ServerReqAddress.BASE_ADDRESS+"sz/ctCruiseStatisticsRestService/outPutPDF?projectSu=SZMSA&accessToken="+ finalAccess_token +"&requestSource=&parameterJson=" +params);
        //文件存储位置
