...
public class ElectronicCruiseExceptionAdapter extends CommonAdapter<CtElectronicCruiseException> {
    ...
    public ElectronicCruiseExceptionAdapter(Context context, List<CtElectronicCruiseException> datas, int resource) {
    ...
    public void convert(ViewHolder holder, int position) {
        ...
        final CtElectronicCruiseException data = datas.get(position);
        tv_boat_name.setText(data.getNoticeOrg());
        tv_ferry_name.setText(data.getExceptionType());
        tv_sj.setText(data.getExceptionTime());
        //开始判断本地是否已经下载文档了
        //文件夹名称
        String path = SDCardUtils.getRootDirectory()+ "/DownloadSZMSA_Doc//";
        //文件名称
        String name = "电子巡航异常"+"_"+data.getInspectNo()+".pdf";
        ...
        final DownInfo apkApi=new DownInfo(ServerReqAddress.BASE_ADDRESS+"sz/ctElectronicCruiseExceptionRestService/outPutPDF?projectSu=SZMSA&accessToken="+access_token+"&requestSource=&parameterJson=" +params);
