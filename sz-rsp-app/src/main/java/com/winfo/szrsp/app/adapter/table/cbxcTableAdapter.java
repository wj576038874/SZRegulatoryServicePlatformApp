 ...
 * @Package: com.winfo.szrsp.app.adapter.table
 * @Filename: cbxcTableAdapter
 * @Author: lsj
 * @Date: 2017/12/8  9:41
 * @Description:
 * @Version:
 */
public class cbxcTableAdapter extends CommonAdapter<ListcbxcData.list> {
     ...
     */
    public cbxcTableAdapter(Context context, List<ListcbxcData.list> datas, int resource) {
    ...
    public void convert(ViewHolder holder, int position) {
        ...
        final ListcbxcData.list data = datas.get(position);
        ...
        final DownInfo apkApi = new DownInfo(ServerReqAddress.BASE_ADDRESS+"sz/tSiteSupervisionRestService/outPutPDF?projectSu=SZMSA&accessToken="+ finalAccess_token +"&requestSource=&parameterJson=" +params);
        //文件存储位置
