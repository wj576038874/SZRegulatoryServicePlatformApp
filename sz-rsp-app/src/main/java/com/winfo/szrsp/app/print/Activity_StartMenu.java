...
public class Activity_StartMenu extends Activity {
    ...
    private void init() {
        ...
        namepath= getIntent().getStringExtra("namepath");
    ...
    private void setListView() {
        ...
        if (namepath!=null&&!namepath.equals("")){
            activityClass.put(0, Activity_PrintPdf.class);
            activityClass.put(1, Activity_PrinterPreference.class);
            ...
            activityClass.put(2, Activity_PrinterPreference.class);
