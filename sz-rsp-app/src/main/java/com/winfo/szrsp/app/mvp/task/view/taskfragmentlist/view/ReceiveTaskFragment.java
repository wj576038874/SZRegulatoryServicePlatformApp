...
public class ReceiveTaskFragment extends Fragment implements ITaskListActivity {
...
//        page=1;
//        this.list.clear();
//        presenter.getTaskListData("1","20","2",false);
//    }
    ...
    private void initData() {
        ...
        presenter.getTaskListData(""+page,"20","2",true);
    }
    ...
    private void initEvent() {
        ...
        mRefreshLayout.setOnLoadmoreListener(new OnLoadmoreListener() {
            ...
            public void onLoadmore(RefreshLayout refreshlayout) {
                ...
                presenter.getTaskListData(""+page,"20","2",false);
