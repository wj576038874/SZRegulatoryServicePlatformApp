...
public class ExceptionShipFinishDialog {
    ...
    public ExceptionShipFinishDialog(Context context) {
        mContext=context;
        ...
        rejectView = LayoutInflater.from(mContext).inflate(R.layout.pop_exception_finish_dec, null);
        dialogReject.show();
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(pop_reject_reason_edt.getText().toString().length()<1){
                    ToastUtils.showToast(mContext,"请填写完成描述");
                }else {
