...
import com.winfo.szrsp.app.widget.wheelview.adapters.WheelAdapter;
 ...
 * 3d滚轮控件
 */
public class MinuteWheelView extends View {
   ...
   // Paint paintIndicator;
    ...
    public MinuteWheelView(Context context, AttributeSet attrs) {
        ...
        textColorCenter = getResources().getColor(R.color.pickerview_wheelview_minutetextcolor_center);
        //dividerColor = getResources().getColor(R.color.pickerview_wheelview_minutetextcolor_center);
    ...
    private void initLoopView(Context context) {
        ...
        handler = new MinuteMessageHandler(this);
        gestureDetector = new GestureDetector(context, new MinuteLoopViewGestureListener(this));
...
//        paintIndicator.setAntiAlias(true);
    ...
    void smoothScroll(ACTION action) {
        ...
        mFuture = mExecutor.scheduleWithFixedDelay(new MinuteSmoothScrollTimerTask(this, mOffset), 0, 10, TimeUnit.MILLISECONDS);
    }

    protected final void scrollBy(float velocityY) {
        cancelFuture();

        mFuture = mExecutor.scheduleWithFixedDelay(new MinuteInertiaTimerTask(this, velocityY), 0, VELOCITYFLING, TimeUnit.MILLISECONDS);
    }
    ...
    protected final void onItemSelected() {
        if (onItemSelectedListener != null) {
            postDelayed(new MinuteOnItemSelectedRunnable(this), 200L);
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //中间两条横线
//        canvas.drawLine(0.0F,  , measuredWidth, firstLineY, paintIndicator);
//        canvas.drawLine(0.0F, secondLineY, measuredWidth, secondLineY, paintIndicator);

//        canvas.drawLine(0.0F, firstLineY, 0.0F, secondLineY, paintIndicator);
       // canvas.drawLine(secondLineY, firstLineY, secondLineY, secondLineY, paintIndicator);
