...
public class DXSHCTableAdapter extends CommonAdapter<CtSpecialShipType0203> {
    /**
     * 构造方法
     *
    ...
    public DXSHCTableAdapter(Context context, List<CtSpecialShipType0203> datas, int resource) {
    ...
    public void convert(ViewHolder holder, int position) {
        ...
        final CtSpecialShipType0203 data = datas.get(position);
        tv_boat_name.setText(data.getShipNameCn());
        tv_ferry_name.setText(data.getShipImo());
      ...
      final   DownInfo apkApi=new DownInfo(ServerReqAddress.BASE_ADDRESS+"sz/ctSpecialShipType0203RestService/outPutPDF?projectSu=SZMSA&accessToken="+access_token+"&requestSource=&parameterJson=" +params);
