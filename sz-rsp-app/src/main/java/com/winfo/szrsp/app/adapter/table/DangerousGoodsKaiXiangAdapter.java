...
public class DangerousGoodsKaiXiangAdapter extends CommonAdapter<DetailDangerousGoodsKaiXiangData> {
     ...
     */
    public DangerousGoodsKaiXiangAdapter(Context context, List<DetailDangerousGoodsKaiXiangData> datas, int resource) {
    ...
    public void convert(ViewHolder holder, int position) {
        ...
        final DetailDangerousGoodsKaiXiangData data = datas.get(position);
        tv_boat_name.setText(data.getCarrierShip());
        tv_ferry_name.setText(data.getGoodName());
        tv_sj.setText(data.getCreateTime());

        //开始判断本地是否已经下载文档了
        //文件夹名称
        String path = SDCardUtils.getRootDirectory() + "/DownloadSZMSA_Doc/";
        //文件名称
        String name = "集装箱危险货物开箱检查记录表" + "_" + data.getInspectNo() + ".pdf";
        ...
        final DownInfo apkApi = new DownInfo(ServerReqAddress.BASE_ADDRESS + "sz/ctDangerPolluteOutRestService/outPutPDF?projectSu=SZMSA&accessToken=" + finalAccess_token + "&requestSource=&parameterJson=" + params);
        //文件存储位置
