 ...
 */
public class MinuteBasePickerView {
    ...
    public MinuteBasePickerView(Context context){
                ...
                decorView.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (onDismissListener != null) {
                            onDismissListener.onDismiss(MinuteBasePickerView.this);
                        }
                    }
                });
            }
    ...
    public MinuteBasePickerView setOnDismissListener(OnDismissListener onDismissListener) {
        this.onDismissListener = onDismissListener;
        return this;
    }

    public MinuteBasePickerView setCancelable(boolean isCancelable) {
