...
public class ExcuteDistributeFragment extends Fragment implements ITaskListActivity {
...
//        page=1;
//        this.list.clear();
//        presenter.getTaskListData("1","20","1,9",false);
//    }
    ...
    private void initData() {
        ...
        presenter.getTaskListData(""+page,"20","1,9",true);
    }
    ...
    private void initEvent() {
        ...
        mRefreshLayout.setOnLoadmoreListener(new OnLoadmoreListener() {
            ...
            public void onLoadmore(RefreshLayout refreshlayout) {
                ...
                presenter.getTaskListData(""+page,"20","1,9",false);
