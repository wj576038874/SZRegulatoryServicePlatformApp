...
public class ContainerWeightInspectAdapter extends CommonAdapter<ContainerWeightInspectData> {
    ...
    public ContainerWeightInspectAdapter(Context context, List<ContainerWeightInspectData> datas, int resource) {
    ...
    public void convert(ViewHolder holder, int position) {
        ...
        final ContainerWeightInspectData data = datas.get(position);
        tv_boat_name.setText(data.getCarrierShip());
        tv_ferry_name.setText(data.getCarrierAgent());
        tv_sj.setText(data.getInspectTime());
        //开始判断本地是否已经下载文档了
        //文件夹名称
        String path = SDCardUtils.getRootDirectory()+ "/DownloadSZMSA_Doc/";
        //文件名称
        String name = "货物集装箱重量验证检查记录表"+"_"+data.getInspectNo()+".pdf";
        ...
        final DownInfo apkApi=new DownInfo(ServerReqAddress.BASE_ADDRESS+"sz/ctCaseWeightInspectRestService/outPutPDF?projectSu=SZMSA&accessToken="+access_token+"&requestSource=&parameterJson=" +params);
