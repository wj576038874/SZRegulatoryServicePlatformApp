...
public class CBWFXCTableAdapter extends CommonAdapter<CtSafetySceneInspect> {
    /**
     * 构造方法
     *
    ...
    public CBWFXCTableAdapter(Context context, List<CtSafetySceneInspect> datas, int resource) {
    ...
    public void convert(ViewHolder holder, int position) {
        ...
        final CtSafetySceneInspect data = datas.get(position);
        ...
        //文件名称
        String name = "船舶危防现场_"+data.getShipNameCn()+"_"+data.getInspectNo()+".pdf";
      ...
      final   DownInfo apkApi=new DownInfo(ServerReqAddress.BASE_ADDRESS+"sz/ctSafetySceneInspectRestService/outPutPDF?projectSu=SZMSA&accessToken="+access_token+"&requestSource=&parameterJson=" +params);
